...
/**
 * Handle Plivo Dtmf Callback
 *
 * Handle DTMF events from Plivo.
 */
export const handlePlivoDtmfCallbackApiV1TelephonyPlivoDtmfCallbackWorkflowRunIdPost = <ThrowOnError extends boolean = false>(options: Options<HandlePlivoDtmfCallbackApiV1TelephonyPlivoDtmfCallbackWorkflowRunIdPostData, ThrowOnError>): RequestResult<HandlePlivoDtmfCallbackApiV1TelephonyPlivoDtmfCallbackWorkflowRunIdPostResponses, HandlePlivoDtmfCallbackApiV1TelephonyPlivoDtmfCallbackWorkflowRunIdPostErrors, ThrowOnError> => (options.client ?? client).post<HandlePlivoDtmfCallbackApiV1TelephonyPlivoDtmfCallbackWorkflowRunIdPostResponses, HandlePlivoDtmfCallbackApiV1TelephonyPlivoDtmfCallbackWorkflowRunIdPostErrors, ThrowOnError>({ url: '/api/v1/telephony/plivo/dtmf-callback/{workflow_run_id}', ...options });
