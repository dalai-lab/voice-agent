    ...
    <DialogPortal data-slot="dialog-portal">
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          ...
          !className?.includes("fixed right-") && !className?.includes("fixed left-") && "top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] w-full max-w-[calc(100%-2rem)] rounded-lg sm:max-w-lg",
          className
        )}
        {...props}
      >
